...
\end{align}
where $\tilde{m}_k = \transpose{\left( \lambda_1 m_{1k}, \ldots, \lambda_D m_{Dk} \right)}$ and $$\var{\beta_k} = \mathrm{diag} \left( \Big[ \lambda_1 \qmat_1^{-1} + \lambda_1(1 - \lambda_1) m_1 \transpose{m_1}\Big]_{kk} \textrm{ }, \textrm{ }\ldots\textrm{ }, \Big[ \lambda_D \qmat_D^{-1} + \lambda_D(1 - \lambda_D) m_D \transpose{m_D}\Big]_{kk} \right)$$ 
...
\begin{align*}
	\frac{\lambda_d}{1- \lambda_d} = \frac{\pi}{1-\pi} \cdot \xi_0^{\frac{K}{2}} \cdot |\qmat_d|^{-\frac{1}{2}} \cdot \exp \Big\{ \frac{1}{2} \cdot \transpose{m_d} \eta_d\Big\}
\end{align*}
