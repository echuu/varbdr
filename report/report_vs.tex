...
\begin{align*}
	...
	&= \sum_{d} \ksum \beta_{kd}^2 \cdot \frac{a_k}{b_k} \cdot \nsum r_{nk} x_{nd}^2 + \sum_{d} \ksum \beta_{kd} \cdot \frac{a_k}{b_k} \cdot \sum_{j\neq d} \big[\sum_n r_{nk} x_{nd} x_{nj} \big] \beta_{kj} \\
