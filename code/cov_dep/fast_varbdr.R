...
source(paste(COV_DEP,  FAST_M_STEP,     sep = '/'))
source(paste(COV_DEP,  ELBO,            sep = '/'))
source(paste(COV_DEP,  MISC_FUNCS,      sep = '/'))
# sourceCpp(paste(COV_DEP,  VB_CPP,          sep = '/'))
...
fast_varbdr = function(y, X, K = 4, intercept = FALSE,
                       ...
                       max_iter = 2e4, tol = 1e-3, VERBOSE = TRUE) {
