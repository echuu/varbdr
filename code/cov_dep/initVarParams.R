...
# alternate constructor which takes user input for m_k, mu_k
# used to test correctness of C++ implementation fo the m-step
# use C++ constructor to generate all of the initial variational parameters
# (m_k, mu_k generated randomly there, then returned to R so that they can
# be initialize here). Then run m-step and match the variational parameters
# after each iteration
initVarParams_0 = function(y, X, N, D, K, intercept = FALSE, max_iter,
                           m_k, mu_k) {
