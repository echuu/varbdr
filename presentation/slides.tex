...
\title[Short title]{Variational Approach for Bayesian Density Regression} % The short title appears at the bottom of every slide, the full title is only on the title page
